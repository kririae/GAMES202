(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    ? define(["exports", "imgui-js"], factory)
    : ((global =
        typeof globalThis !== "undefined" ? globalThis : global || self),
      factory((global.ImGui_Impl = {}), global.ImGui));
})(this, function (exports, ImGui) {
  "use strict";
  ...
  function RenderDrawData(draw_data = ImGui.GetDrawData()) {
    ...
    const gl2 =
      (typeof WebGL2RenderingContext !== "undefined" &&
        exports.gl instanceof WebGL2RenderingContext &&
        exports.gl) ||
      null;
    const gl_vao =
      (exports.gl && exports.gl.getExtension("OES_vertex_array_object")) ||
      null;
    // Backup GL state
    const last_active_texture =
      (exports.gl && exports.gl.getParameter(exports.gl.ACTIVE_TEXTURE)) ||
      null;
    const last_program =
      (exports.gl && exports.gl.getParameter(exports.gl.CURRENT_PROGRAM)) ||
      null;
    const last_texture =
      (exports.gl && exports.gl.getParameter(exports.gl.TEXTURE_BINDING_2D)) ||
      null;
    const last_array_buffer =
      (exports.gl &&
        exports.gl.getParameter(exports.gl.ARRAY_BUFFER_BINDING)) ||
      null;
    const last_element_array_buffer =
      (exports.gl &&
        exports.gl.getParameter(exports.gl.ELEMENT_ARRAY_BUFFER_BINDING)) ||
      null;
    const last_vertex_array_object =
      (gl2 && gl2.getParameter(gl2.VERTEX_ARRAY_BINDING)) ||
      (exports.gl &&
        gl_vao &&
        exports.gl.getParameter(gl_vao.VERTEX_ARRAY_BINDING_OES)) ||
      null;
    // GLint last_polygon_mode[2]; glGetIntegerv(GL_POLYGON_MODE, last_polygon_mode);
    const last_viewport =
      (exports.gl && exports.gl.getParameter(exports.gl.VIEWPORT)) || null;
    const last_scissor_box =
      (exports.gl && exports.gl.getParameter(exports.gl.SCISSOR_BOX)) || null;
    const last_blend_src_rgb =
      (exports.gl && exports.gl.getParameter(exports.gl.BLEND_SRC_RGB)) || null;
    const last_blend_dst_rgb =
      (exports.gl && exports.gl.getParameter(exports.gl.BLEND_DST_RGB)) || null;
    const last_blend_src_alpha =
      (exports.gl && exports.gl.getParameter(exports.gl.BLEND_SRC_ALPHA)) ||
      null;
    const last_blend_dst_alpha =
      (exports.gl && exports.gl.getParameter(exports.gl.BLEND_DST_ALPHA)) ||
      null;
    const last_blend_equation_rgb =
      (exports.gl && exports.gl.getParameter(exports.gl.BLEND_EQUATION_RGB)) ||
      null;
    const last_blend_equation_alpha =
      (exports.gl &&
        exports.gl.getParameter(exports.gl.BLEND_EQUATION_ALPHA)) ||
      null;
    const last_enable_blend =
      (exports.gl && exports.gl.getParameter(exports.gl.BLEND)) || null;
    const last_enable_cull_face =
      (exports.gl && exports.gl.getParameter(exports.gl.CULL_FACE)) || null;
    const last_enable_depth_test =
      (exports.gl && exports.gl.getParameter(exports.gl.DEPTH_TEST)) || null;
    const last_enable_scissor_test =
      (exports.gl && exports.gl.getParameter(exports.gl.SCISSOR_TEST)) || null;
    // Setup desired GL state
    // Recreate the VAO every time (this is to easily allow multiple GL contexts to be rendered to. VAO are not shared among GL contexts)
    // The renderer would actually work without any VAO bound, but then our VertexAttrib calls would overwrite the default one currently bound.
    const vertex_array_object =
      (gl2 && gl2.createVertexArray()) ||
      (gl_vao && gl_vao.createVertexArrayOES());
    // Setup render state: alpha-blending enabled, no face culling, no depth testing, scissor enabled, polygon fill
    exports.gl && exports.gl.enable(exports.gl.BLEND);
    exports.gl && exports.gl.blendEquation(exports.gl.FUNC_ADD);
    exports.gl &&
      exports.gl.blendFunc(
        exports.gl.SRC_ALPHA,
        exports.gl.ONE_MINUS_SRC_ALPHA
      );
    ...
    exports.gl &&
      exports.gl.vertexAttribPointer(
        ...
        true,
        ImGui.DrawVertSize,
        ImGui.DrawVertColOffset
      );
    // Draw
    const pos = draw_data.DisplayPos;
    const idx_buffer_type =
      (exports.gl &&
        (ImGui.DrawIdxSize === 4
    ...
    draw_data.IterateDrawLists((draw_list) => {
      ...
      exports.gl ||
        exports.ctx ||
        console.log("VtxBuffer.length", draw_list.VtxBuffer.length);
      exports.gl ||
        exports.ctx ||
        console.log("IdxBuffer.length", draw_list.IdxBuffer.length);
      let idx_buffer_offset = 0;
      exports.gl && exports.gl.bindBuffer(exports.gl.ARRAY_BUFFER, g_VboHandle);
      exports.gl &&
        exports.gl.bufferData(
          exports.gl.ARRAY_BUFFER,
          draw_list.VtxBuffer,
          exports.gl.STREAM_DRAW
        );
      exports.gl &&
        exports.gl.bindBuffer(
          exports.gl.ELEMENT_ARRAY_BUFFER,
          g_ElementsHandle
        );
      exports.gl &&
        exports.gl.bufferData(
      ...
      draw_list.IterateDrawCmds((draw_cmd) => {
        ...
        if (!exports.gl && !exports.ctx) {
          ...
          for (let i = 0; i < Math.min(3, draw_cmd.ElemCount); ++i) {
            const view = new ImGui.DrawVert(
              draw_list.VtxBuffer.buffer,
              draw_list.VtxBuffer.byteOffset + i * ImGui.DrawVertSize
            );
            console.log(
        ...
        if (draw_cmd.UserCallback !== null) {
          ...
          if (
            ...
            exports.gl &&
              exports.gl.bindTexture(exports.gl.TEXTURE_2D, draw_cmd.TextureId);
            exports.gl &&
              exports.gl.drawElements(
                exports.gl.TRIANGLES,
                draw_cmd.ElemCount,
                idx_buffer_type,
                idx_buffer_offset
              );
            if (exports.ctx) {
              ...
              for (let i = 0; i < draw_cmd.ElemCount; i += 3) {
                ...
                const v0 = new ImGui.DrawVert(
                  draw_list.VtxBuffer.buffer,
                  draw_list.VtxBuffer.byteOffset + i0 * ImGui.DrawVertSize
                );
                const v1 = new ImGui.DrawVert(
                  draw_list.VtxBuffer.buffer,
                  draw_list.VtxBuffer.byteOffset + i1 * ImGui.DrawVertSize
                );
                const v2 = new ImGui.DrawVert(
                  draw_list.VtxBuffer.buffer,
                  draw_list.VtxBuffer.byteOffset + i2 * ImGui.DrawVertSize
                );
                const i3 = idx[i + 3];
                const i4 = idx[i + 4];
                const i5 = idx[i + 5];
                const v3 = new ImGui.DrawVert(
                  draw_list.VtxBuffer.buffer,
                  draw_list.VtxBuffer.byteOffset + i3 * ImGui.DrawVertSize
                );
                const v4 = new ImGui.DrawVert(
                  draw_list.VtxBuffer.buffer,
                  draw_list.VtxBuffer.byteOffset + i4 * ImGui.DrawVertSize
                );
                const v5 = new ImGui.DrawVert(
                  draw_list.VtxBuffer.buffer,
                  draw_list.VtxBuffer.byteOffset + i5 * ImGui.DrawVertSize
                );
                let quad = true;
                let minmin = v0;
                let minmax = v0;
                ...
                if (quad) {
                  if (
                    minmin.uv[0] === maxmax.uv[0] ||
                    minmin.uv[1] === maxmax.uv[1]
                  ) {
                    // one vertex color
                    exports.ctx.beginPath();
                    exports.ctx.rect(
                    ...
                    exports.ctx.fillStyle = `rgba(${(v0.col[0] >> 0) & 0xff}, ${
                      (v0.col[0] >> 8) & 0xff
                    }, ${(v0.col[0] >> 16) & 0xff}, ${
    ...
    exports.gl &&
      last_texture !== null &&
      exports.gl.bindTexture(exports.gl.TEXTURE_2D, last_texture);
    exports.gl &&
      last_active_texture !== null &&
      exports.gl.activeTexture(last_active_texture);
    ...
    exports.gl &&
      ...
      exports.gl.blendEquationSeparate(
  ...
  function CreateFontsTexture() {
    ...
    exports.gl &&
      exports.gl.texParameteri(
        exports.gl.TEXTURE_2D,
        exports.gl.TEXTURE_MIN_FILTER,
        exports.gl.LINEAR
      );
    exports.gl &&
      exports.gl.texParameteri(
        exports.gl.TEXTURE_2D,
        exports.gl.TEXTURE_MAG_FILTER,
        exports.gl.LINEAR
      );
    // gl && gl.pixelStorei(gl.UNPACK_ROW_LENGTH); // WebGL2
    exports.gl &&
      exports.gl.texImage2D(
        exports.gl.TEXTURE_2D,
        0,
        exports.gl.RGBA,
        width,
  ...
  function CreateDeviceObjects() {
    ...
    g_VertHandle =
      exports.gl && exports.gl.createShader(exports.gl.VERTEX_SHADER);
    g_FragHandle =
      exports.gl && exports.gl.createShader(exports.gl.FRAGMENT_SHADER);
    exports.gl &&
      exports.gl.shaderSource(g_VertHandle, vertex_shader.join("\n"));
    exports.gl &&
    ...
    g_AttribLocationPosition =
      (exports.gl &&
        exports.gl.getAttribLocation(g_ShaderHandle, "Position")) ||
      0;
    g_AttribLocationUV =
      (exports.gl && exports.gl.getAttribLocation(g_ShaderHandle, "UV")) || 0;
    g_AttribLocationColor =
      (exports.gl && exports.gl.getAttribLocation(g_ShaderHandle, "Color")) ||
      0;
